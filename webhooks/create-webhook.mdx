...
<Note>
  Nem todo evento existe em todo canal. Confira a [tabela de eventos por canal](/webhooks/introduction#eventos-disponíveis) antes de configurar — cadastrar um evento indisponível não retorna erro, mas o webhook nunca recebe nada.
</Note>

...
|---|---|---|
| **WhatsApp Business** | Yes | A new customer message — which an [approved template](/en/messages/send-template) can prompt. The template itself does not reopen the window. |
...
<Steps>
  ...
  <Step title="You send a template and the customer replies">
    Send an [approved template](/en/messages/send-template) (marketing, utility, or authentication). The template alone does not reopen the window: it is the **customer's reply** that opens a new 24h window and unlocks [free messages](/en/messages/introduction) again.
  </Step>
</Steps>

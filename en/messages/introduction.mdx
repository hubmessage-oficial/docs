...
| `AUDIO` | Audio message |
| `VIDEO` | Video message |
| `DOCUMENT` | Document message (PDF, DOC, XLS, etc) |
...
<Info>
  Going to send media (image, audio, video, sticker or document)? Check the accepted formats, size limits and error codes at [Media validations](/en/messages/media-validations).
</Info>

...
Accepted formats: JPEG, PNG, BMP, TIFF, GIF, WebP, SVG (non JPEG/PNG are converted — SVG becomes PNG, the others become JPEG); max size **5 MB**; caption up to 1024 characters. See all the details at [Media validations](/en/messages/media-validations).

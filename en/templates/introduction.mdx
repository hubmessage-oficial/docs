---
title: "Introduction"
description: "Understand how message templates work in Hub Message"
---
...
<Note>
  Template management through this API is exclusive to **`META_WHATSAPP`** channels. Instagram, Messenger, and Telegram Bot do not use these endpoints.
</Note>
...
The API organizes templates by **business** (WABA — WhatsApp Business Account). In Hub Message, this identifier is exposed as `businessId`. Each business has its own templates, approval history, and limits.
